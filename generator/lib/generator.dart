...
4. **Test the submission in game** before submitting/accepting it. If it has a corresponding level, make sure it syncs with it. If it's a remix/mashup, make sure it syncs with the replaced song. You can test in-game by adding a new song and copying the YouTube ID from the submission.
5. Links from Google Drive, Mediafire, Dropbox, etc., are not allowed. Please only submit YouTube video links or **permanent** direct download links from CDNs that have given permission for Auto Nong to download from. Currently, there are no allowed CDNs. If you don't want to upload to YouTube, submit to the SFH.
